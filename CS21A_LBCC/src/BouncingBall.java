/**
 * This is an example program from CS106A-Stanford Online course
 * 
 * Author: Juan A. Uribe
 * Date: September 4, 2013
 * Program Description: This program creates a ball that bounces and travels
 * left to right until the end of the applet window.
 * 
 * Updates:
 */
...
public class BouncingBall extends GraphicsProgram {
	...
	/**
	 * Amount Y velocity is increased each cycle as a result
	 * of gravity
	 */
